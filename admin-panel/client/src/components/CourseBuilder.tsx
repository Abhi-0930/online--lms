  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        className={cn(
          "flex w-full items-center justify-between rounded-xl border bg-white px-4 py-3 text-left text-xs sm:text-[13px] font-medium transition-all duration-150 select-none shadow-xs",
          isOpen
            ...
            <div className="mt-10 pt-6 border-t border-slate-100 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-2.5">
                <button
                  ...
                  className="rounded-xl border border-slate-200 bg-slate-50/60 px-4 py-2.5 text-xs sm:text-[13px] font-semibold text-slate-400 cursor-not-allowed transition"
                >
                  ← Back
                </button>
                <button
