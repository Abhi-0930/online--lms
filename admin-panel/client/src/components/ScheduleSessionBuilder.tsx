        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-7">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200/90 dark:border-white/10 bg-white dark:bg-[#121620] p-6 shadow-sm space-y-5">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02] flex items-center justify-between">
                    <div>
                      <p className="text-xs font-bold text-slate-900 dark:text-white">Email Reminders</p>
                      <p className="text-[11px] text-slate-400">Send calendar invite & email alert</p>
                    </div>
                    <button
                      type="button"
                      onClick={() => setData({ ...data, emailReminders: !data.emailReminders })}
                      className={cn(
                        "relative h-5 w-9 rounded-full transition-colors cursor-pointer",
                        data.emailReminders ? "bg-indigo-600" : "bg-slate-300 dark:bg-white/10"
                      )}
                    >
                      <span
                        className={cn(
                          "absolute top-0.5 h-4 w-4 rounded-full bg-white shadow-xs transition-transform",
                          data.emailReminders ? "translate-x-4" : "translate-x-0.5"
                        )}
                      />
                    </button>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02] flex items-center justify-between">
                    <div>
                      <p className="text-xs font-bold text-slate-900 dark:text-white">In-App Notification</p>
                      <p className="text-[11px] text-slate-400">Banner & push notification</p>
                    </div>
                    <button
                      type="button"
                      onClick={() => setData({ ...data, inAppNotifications: !data.inAppNotifications })}
                      className={cn(
                        "relative h-5 w-9 rounded-full transition-colors cursor-pointer",
                        data.inAppNotifications ? "bg-indigo-600" : "bg-slate-300 dark:bg-white/10"
                      )}
                    >
                      <span
                        className={cn(
                          "absolute top-0.5 h-4 w-4 rounded-full bg-white shadow-xs transition-transform",
                          data.inAppNotifications ? "translate-x-4" : "translate-x-0.5"
                        )}
                      />
                    </button>
                  </div>
                ...
                {[
                  ...
                  return (
                    <div
                      ...
                      className="p-3.5 rounded-2xl border border-slate-200/80 dark:border-white/5 bg-slate-50/40 dark:bg-white/[0.01] flex items-center justify-between cursor-pointer hover:border-slate-300 dark:hover:border-white/20 transition"
                    >
                      <div>
                      ...
                      <div
                        className={cn(
                          ...
                          val ? "bg-indigo-600" : "bg-slate-300 dark:bg-white/10"
                        )}
                      >
                        <span
                          className={cn(
            ...
            <div className="rounded-2xl border border-slate-200/90 dark:border-white/10 bg-white dark:bg-[#121620] p-6 shadow-sm space-y-5">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02] flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() => setData({ ...data, trackAttendance: !data.trackAttendance })}
                    className={cn(
                      "relative h-5 w-9 rounded-full transition-colors cursor-pointer",
                      data.trackAttendance ? "bg-indigo-600" : "bg-slate-300 dark:bg-white/10"
                    )}
                  >
                    <span
                      className={cn(
                        "absolute top-0.5 h-4 w-4 rounded-full bg-white shadow-xs transition-transform",
                        data.trackAttendance ? "translate-x-4" : "translate-x-0.5"
                      )}
                    />
                  </button>
                </div>
